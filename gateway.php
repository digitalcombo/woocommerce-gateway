...
/**
* Plugin Name: Checkout Transparente Digital Combo para Woocommerce com assinaturas recorrentes neste cartão
* Plugin URI: https://www.digitalcombo.com/
* Description:  Checkout de pagamento das soluções Digital Combo - Receba pagamentos por boleto, cartão de crédito e débito. Ative pagamentos recorrentes instalando junto o plugin woocommerce subscriptions.
* Version: 0.1
* Author: Digital Combo
* Author URI: http://digitalcombo.com/
*/
